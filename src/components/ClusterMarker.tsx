...
const ClusterBubble = ({ text }: { text: string | number }) => {
	return (
		<div className="pop-in min-w-[32px] min-h-[32px] p-2 aspect-square grow-0 shrink-0 cursor-pointer flex justify-center items-center rounded-full bg-gradient-to-t from-neutral-900 via-neutral-900 to-neutral-700 border border-neutral-900/50 text-neutral-50 text-sm/tight font-bold opacity-[0.97] shadow-[0_3px_5px_rgba(0,0,0,0.33)]">
